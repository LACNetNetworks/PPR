...
export function SponsorSidebar() {
  ...
  const { recentProjects } = useRecentProjects('sponsor', 3)

  const rolePrefix = '/sponsor'

  // Check if we're on a project detail page
  const projectDetailMatch = pathname?.match(/^\/sponsor\/projects\/([^/]+)/)
  ...
  return (
    <Sidebar>
      ...
      <SidebarBody>
        <SidebarSection>
          <SidebarItem href="/sponsor" current={pathname === '/sponsor'}>
            <HomeIcon />
          ...
          {isOnProjectDetail && projectId ? (
            ...
            >
              ...
              <SidebarSubItem
                className="!pl-12 opacity-60 cursor-not-allowed pointer-events-none"
              >
              ...
              <SidebarSubItem
                href={`${rolePrefix}/projects/${projectId}/permissions`}
                current={pathname === `${rolePrefix}/projects/${projectId}/permissions`}
              >
            ...
            <SidebarItem href="/sponsor/my-projects" current={pathname === '/sponsor/my-projects'}>
              <Square2StackIcon />
